...
$ vagrant halt web 
$ vagrant status 
$ vagrant up # brings up both clear vagrant ssh web ifconfig | grep inet ssh 192.168.10.3 ifconfig | grep inet exit clear nc -z -w1 192.168.10.3 3306 exit vagrant halt cd
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjkxNDQ3MywxNjA1ODgzMTcxXX0=
-->