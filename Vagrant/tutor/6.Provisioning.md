...
service httpd start
 ...
 service httpd restart exit pwd mate info.php ls vagrant ssh clear sudo yum install -y mysql mysql-server mysql-devel sudo chkconfig --add mysqld sudo chkconfig mysqld on sudo service mysqld start 
$ cd projects/ 
$ mkdir baked-lamp 
$ cd baked-lamp 
$ vagrant init chef/centos-6.5 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMyMzk5NTE3MywyMDAwODUzMjgwLDYxNj
Y2NTk0NCw2MTY2NjU5NDQsMTY2MDcwNTAzNywtNzY1MzczNjc0
LDczMDk5ODExNl19
-->